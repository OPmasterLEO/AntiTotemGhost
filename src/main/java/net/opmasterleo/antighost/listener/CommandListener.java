package net.opmasterleo.AntiTotemGhost.listener;
...
import net.opmasterleo.AntiTotemGhost.AntiTotemGhost;
...
public final class CommandListener implements CommandExecutor, TabCompleter {
    ...
    private static final String PREFIX = ChatColor.GOLD + "[AntiTotemGhost] " + ChatColor.RESET;
    private static final List<String> SUBCOMMANDS = Arrays.asList("reload", "debug", "stats", "compat");

    private final AntiTotemGhost plugin;
    ...
    public CommandListener(AntiTotemGhost plugin,
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("AntiTotemGhost.admin")) {
    ...
    private void sendHelp(CommandSender sender, String label) {
        sender.sendMessage(PREFIX + ChatColor.AQUA + "AntiTotemGhost v" + plugin.getDescription().getVersion());
